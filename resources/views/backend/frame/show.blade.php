                        ...
                        <div class="form-group text-center">
                            ...
                            <div class="controls">
                                <div class="input-group">
                                    <input class="form-control" type="text" value="{{ route('upload',$frame->link_frame) }}"><span class="input-group-append">
                                        <button class="btn btn-secondary btn-sm" type="button" data-toggle="tooltip" data-placement="top" title="" data-original-title="Copy">
